...
// BlockComment: '/*' .*? '*/';
BlockCommentStart: '/*' '*'?;
BlockCommentBody: '*' .*? Newline;
BlockCommentEnd: '*/';

LineComment: '//' ~ [\r\n]*;

fragment AttributeSpecifier: DoubleLeftBracket .*? DoubleRightBracket;

ClassExpression: (Class | Struct | Union) AttributeSpecifier? NONDIGIT* Final? Colon? NONDIGIT*? LeftBrace;

//LambdaExpression: LeftBracket .*? RightBracket
//                  Less? .*? Greater?
